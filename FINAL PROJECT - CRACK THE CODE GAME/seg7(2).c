...
#define PORT_PERIPH     SYSCTL_PERIPH_GPIOB // The peripheral def of Port A
#define PORT            GPIO_PORTB_BASE     // The base address of the I2C port
#define CLK             GPIO_PIN_0          // The 8-bit pin value (mask format) for clock
#define DIO             GPIO_PIN_1          // The 8-bit pin value (mask format) for data IO
